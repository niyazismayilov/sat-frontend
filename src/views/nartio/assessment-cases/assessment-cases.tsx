...
export const AssessmentCases: React.FC = () => {
    const cases = [
        'İşə qəbul',
        'Şirkət daxilində vəzifə artımları, dəyişimləri',
        'Əməkdaşların təlim ehtiyaclarının təyini',
        'İstedadların kəşfi',
        'Gənc istedad proqramları',
        'Vəzifələr üzrə səriştə tələblərinin təyini',
    ];
        ...
        <Wrapper>
            <Container maxWidth="lg">
                <Typography className="title">
                    Nartio platforması aşağıdakı hallarda qiymətləndirmə aparmağa imkan verir
                </Typography>
                <Grid container spacing={3}>
                    {cases.map((caseItem, index) => (
                        <Grid item xs={12} sm={6} md={4} key={index}>
                            <Box className="card">
                                <Typography className="card-text">{caseItem}</Typography>
                            </Box>
                        </Grid>
                    ))}
                </Grid>
