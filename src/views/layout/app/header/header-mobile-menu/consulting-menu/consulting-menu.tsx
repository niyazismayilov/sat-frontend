...
import { ConsultingMenuItem } from './consulting-menu-item';
...
export const ConsultingMenu: React.FC<{ item: any; onClose: () => void }> = ({ item, onClose }) => {
    ...
    return (
        <>
            ...
            <Collapse in={open} timeout="auto" unmountOnExit>
                <ConsultingMenuItem onClose={onClose} />
            </Collapse>
        </>
    );
};
