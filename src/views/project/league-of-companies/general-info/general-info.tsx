            ...
            <Root>
                <Container>
                    <BounceInRight>
                        ...
                        <Typography className="info title"> {t('leagueOfCompanies:generalTitle')}</Typography>
                        <Typography className="info text"> {t('leagueOfCompanies:general_first')}</Typography>
                        <Typography className="info text"> {t('leagueOfCompanies:general_second')}</Typography>
                    </BounceInRight>
                </Container>
            </Root>
        </>
