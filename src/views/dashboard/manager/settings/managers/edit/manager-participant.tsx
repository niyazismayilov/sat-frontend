...
import { Gender, useUpdateUsersPermissionsUserMutation, useUsersPermissionsUserQuery } from 'graphql/generated';
import { useState } from 'react';
import { useParams } from 'react-router-dom';
import browserHistory from 'utils/browser-utils';
import { ManagerEditRoleDialog } from './edit-role-dialog';
...
export const EditManager: React.FC = () => {
    ...
    const [updateManager] = useUpdateUsersPermissionsUserMutation({
        onCompleted() {
    ...
    return (
        <Root>
            <Page title="Meneceri Redaktə et">
                <ManagerEditRoleDialog
                    managerDialogOpen={managerDialogOpen}
                    onClose={() => setManagerDialogOpen(false)}
                    managerId={usersPermissionsUserId as string}
                />
                <ManagerPageHeader title="Meneceri Redaktə et" />
