...
import { useBlogFilterDispatch } from 'context/useful/blog/store';
...
export const BlogsActions: React.FC<CustomersActionsProps> = ({ openFilterDialog }) => {
    const dispatch = useBlogFilterDispatch();
                ...
                {isMobile ? (
                    <>
                        <Tooltip title="Yeni bloq" arrow>
                            <IconButton sx={{ ml: 3 }} onClick={() => browserHistory.push('/d/helpful/blog/create')}>
                                <AddIcon />
                            </IconButton>
                        </Tooltip>
                            ...
                            {({ handleSubmit }) => (
                                <Form onSubmit={handleSubmit}>
                                    <Field
                                        name="search"
                                        component={TextField}
                                        placeholder="Bloqun adına görə axtar"
                                        variant="outlined"
                                        InputProps={{
                                            startAdornment: (
                                                <InputAdornment
