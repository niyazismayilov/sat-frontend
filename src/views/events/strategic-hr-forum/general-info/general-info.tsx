            ...
            <Root>
                <Container>
                    ...
                    <BounceInRight>
                        ...
                        <Typography className="info title"> {t('strategicHrForum:generalTitle')}</Typography>
                        <Typography className="info text"> {t('strategicHrForum:general_first')}</Typography>
                        <Typography className="info text"> {t('strategicHrForum:general_second')}</Typography>
                    </BounceInRight>
                </Container>
            </Root>
        </>
